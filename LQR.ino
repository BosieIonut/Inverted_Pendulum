...
float e,u;
float x1,x2,x3,x4;
float x1l=0,x2l=0,x3l=0,x4l=0;
void calculeaza_comanda()
{

    x1 = +0.3614  * x1l +0.0000275   * x2l +0.009347 * x3l + 0.00002281 * x4l + 0.6365    * e;
    x2 = +0.09719 * x1l +1.002       * x2l -0.04436  * x3l + 0.00154    * x4l - 0.3394    * e;
    x3 = -1.728   * x1l +0.005488    * x2l +0.8702   * x3l + 0.004557   * x4l + 1.301     * e;
    x4 = -1.028   * x1l +0.01439     * x2l -0.1852   * x3l + 1.006      * x4l - 0.072     * e; 

    u = -1765 * x1 + 23.1 * x2 - 297.4 * x3 + 21.18 * x4;
    u = u / 2;
    x4l = x4;
    x3l = x3;
    x2l = x2;
